...
const changeTitle = function () {
    document.getElementsByTagName("h1")[0].innerText = "EPICODE EDUCATION"
};
changeTitle()
...
const changePcontent = function () {
    ...
    for (let i = 0; i < divp.length; i++) {
        divp[i].innerText = "Scritta cambiata";
    }
}
changePcontent();
...
const addToTheSecond = function () {
    ...
    secondList.innerHTML += "<li> 4rd </lin>";
}
...
const hideFirstUl = function () {
    document.getElementById("firsList").setAttribute("style", "display: none")
};
